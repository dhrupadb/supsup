...
#SBATCH --mem=30GB
#SBATCH --job-name=supsup-7-ssoft-basis
#SBATCH --mail-type=END
#SBATCH --mail-user=db4045@nyu.edu
#SBATCH --gres=gpu:1
#SBATCH --output=logs/slurm_supsup_signed_soft_basis_7_%j.out
