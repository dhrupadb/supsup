...
#SBATCH --mem=10GB
#SBATCH --job-name=supsup-normalpha
#SBATCH --mail-type=END
#SBATCH --mail-user=db4045@nyu.edu
#SBATCH --account=cds
#SBATCH --gres=gpu:1
#SBATCH --output=logs/slurm_supsup_normalpha_10_%j.out
...
#/home/db4045/.mypy/bin/python $SRCDIR/basis.py --data="/scratch/db4045/data" --seed=0 --seed-model="/scratch/db4045/runs/dhrupad_runs/SupsupSeed/rn18-supsup/id=supsup~seed=0~sparsity=75~try=0/final.pt" --config $SRCDIR/experiments/basis/splitcifar100/configs/rn18-supsup-basis-multitask-normalpha.yaml --name 'dhrupad_supsup_regularized_alphas_hard_masks~al='$AL'~wd='$WD'~LR='$LR'~norm='$AN --log-dir=/scratch/db4045/runs/dhrupad_runs/NormAlphaRandInit/ --num-seed-tasks-learned 10 --epochs 15 --al $AL --trainer alphareg --wd $WD --lr $LR --multigpu="0" --log-alphas --train_mask_alphas --alpha-norm $AN
/home/db4045/.mypy/bin/python $SRCDIR/basis.py --data="/scratch/db4045/data" --seed=0 --seed-model="/scratch/db4045/runs/dhrupad_runs/SupsupSeed/rn18-supsup/id=supsup~seed=0~sparsity=75~try=0/final.pt" --config $SRCDIR/experiments/basis/splitcifar100/configs/rn18-supsup-basis-multitask-normalpha.yaml --name 'dhrupad_supsup_regularized_alphas_hard_masks~al='$AL'~wd='$WD'~LR='$LR'~norm='$AN --log-dir=/scratch/db4045/runs/dhrupad_runs/NormAlphaRandInit/ --num-seed-tasks-learned 10 --epochs 300 --al $AL --trainer alphareg --wd $WD --lr $LR --multigpu="0" --train_mask_alphas --alpha-norm $AN --log-alphas
...
#/home/db4045/.mypy/bin/python $SRCDIR/basis.py --data="/scratch/db4045/data" --seed=0 --seed-model="/scratch/db4045/runs/dhrupad_runs/SupsupSeedWeightnorm/rn18-supsup/id=supsup-weightnorm~seed=0~try=0/final.pt" --config $SRCDIR/experiments/basis/splitcifar100/configs/rn18-supsup-weightnorm.yaml --name 'dhrupad_supsup_regularized_alphas_soft_masks~al='$AL'~wd='$WD'~LR='$LR'~norm='$AN --log-dir=/scratch/db4045/runs/dhrupad_runs/AlphaMultiNormRandInit/ --num-seed-tasks-learned 10 --epochs 300 --al $AL --trainer alphareg --wd $WD --lr $LR --multigpu="0" --log-alphas --train_mask_alphas --alpha-norm $AN
