...
#SBATCH --time=8:00:00
#SBATCH --mem=30GB
#SBATCH --job-name=supsup-7-basis-one-task-hybrid
#SBATCH --mail-type=END
#SBATCH --mail-user=db4045@nyu.edu
#SBATCH --gres=gpu:1
#SBATCH --account=cds
#SBATCH --output=logs/slurm_supsup_hybrid_basis_one_task_7_%j.out
