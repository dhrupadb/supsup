...
#SBATCH --mem=30GB
#SBATCH --job-name=supsup-75-basis-one-task
#SBATCH --mail-type=END
#SBATCH --mail-user=db4045@nyu.edu
#SBATCH --gres=gpu:1
#SBATCH --account=cds
#SBATCH --output=logs/slurm_supsup_basis_one_task_75_%j.out
