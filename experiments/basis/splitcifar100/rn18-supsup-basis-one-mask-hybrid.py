...
def main():
    ...
    log_dir = "{scratch}/runs/{logdir_prefix}/SupsupBasisSingleMaskHybrid/rn18-supsup_basis_num_masks_{num_masks}".format(num_masks=str(args.num_masks), scratch=os.environ.get("SCRATCH"), logdir_prefix=args.logdir_prefix)
    experiments = []
