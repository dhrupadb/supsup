...
def main():
    ...
    config = "experiments/basis/splitcifar100/configs/rn18-supsup-signed-soft.yaml"
    log_dir = "{scratch}/runs/{logdir_prefix}/SupsupBasisSignedHybrid/rn18-supsup_basis_num_masks_{num_masks}".format(num_masks=str(args.num_masks), scratch=os.environ.get("SCRATCH"), logdir_prefix=args.logdir_prefix)
    experiments = []
